    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/admin/boardNotifyHistory" class="nav-item nav-link active"><i class="fa-solid fa-list-ul me-2"></i>게시글 신고내역</a>
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-white text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="/admin/boardNotifyHistory?page=1&search=status&keyword=INACTIVE">정지된 글만 보기</a>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <select id="bn-amountSelect" onchange="bnAmountChange()">
                            ...
                            <div class="search-layout d-flex justify-content-end">
                                ...
                                <input id="bn-input" type="text" placeholder="Search">
                                <i class="search-icon fa fa-search" onclick="boardNotifySearch()"></i>
                            </div>
                        </div>
                        ...
                        <table class="am-table">
                            ...
                            <c:forEach var="notify" items="${allBoardNotify}">
                                <tr>
                                    ...
                                    <td style="width: 25%;"><a href="/board/content?id=${notify.id}"> ${notify.title}</a></td>
                                    <td style="width: 10%;">${notify.createTime}</td>
                                    <td style="width: 10%;">${notify.status}</td>
                                    <td style="width: 12%;">
                                        <button style="width: 65%;" class="status-btn">button</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
                            ...
                            <ul class="pagination">
                                <c:if test="${page.prev }">
                                    <li class="page-item"><a
                                            href="${contextPath}/admin/boardNotifyHistory?real=${page.count}&amount=${page.count}&page=${page.pageParam.page-1}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                ...
                                <c:if test="${page.next }">
                                    <c:if test ="${page.endPage<page.realEnd}">
                                        <li class="page-item"><a
                                                href="${contextPath}/admin/boardNotifyHistory?real=${page.count}&amount=${page.count}&page=${page.endPage+1}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                                class="page-link">다음</a></li>
                                    </c:if>
                                    <c:if test ="${page.endPage>=page.realEnd}">
                                        <li class="page-item"><a
                                                href="${contextPath}/admin/boardNotifyHistory?real=${page.count}&amount=${page.count}&page=${page.endPage}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                                class="page-link">다음</a></li>
                                    </c:if>
                                </c:if>
                            </ul>
...
<script src="../../../../resources/js/manager/boardNotifyHistory.js"></script>
</body>
</html>