    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/admin/boardList" class="nav-item nav-link active"><i class="fa-solid fa-border-all me-2"></i>전체 게시글</a>
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-white text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">전체 게시글</h6>
                            <a href="#" class="board-window">마켓 게시글 바로가기</a>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <select id="bl-amountSelect" onchange="blAmountChange()">
                            ...
                            <div class="search-layout d-flex justify-content-end">
                                ...
                                <input id="bl-input" type="text" placeholder="Search">
                                <i class="search-icon fa fa-search" onclick="boardSearch()"></i>
                            </div>
                        </div>
                        ...
                        <div>
                            <table class="am-table">
                                ...
                                <c:forEach var="board" items="${boardList}">
                                    <tr>
                                        <td style="width: 10%;">${board.id}</td>
                                        <td style="width: 10%;">${board.nickname}</td>
                                        <td style="width: 15%;"><a href="/board/content?id=${board.id}">${board.title}</a></td>
                                        <td style="width: 29%;">${board.contents}</td>
                                        <td style="width: 8%;">${board.viewCount}</td>
                                        <td style="width: 10%;">${board.createTime}</td>
                                        <td style="width: 8%;">${board.wishCount}</td>
                                        <td style="width: 10%;">${board.status}</td>
                                    </tr>
                                </c:forEach>
                            </table>
                                ...
                                <ul class="pagination">
                                    <c:if test="${page.prev }">
                                        <li class="page-item"><a
                                                href="${contextPath}/admin/boardList?real=${page.count}&amount=${page.count}&page=${page.pageParam.page-1}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                    ...
                                    <c:if test="${page.next }">
                                        <c:if test ="${page.endPage<page.realEnd}">
                                            <li class="page-item"><a
                                                    href="${contextPath}/admin/boardList?real=${page.count}&amount=${page.count}&page=${page.endPage+1}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                                    class="page-link">다음</a></li>
                                        </c:if>
                                        <c:if test ="${page.endPage>=page.realEnd}">
                                            <li class="page-item"><a
                                                    href="${contextPath}/admin/boardList?real=${page.count}&amount=${page.count}&page=${page.endPage}&search=${page.pageParam.search}&keyword=${page.pageParam.keyword}"
                                                    class="page-link">다음</a></li>
                                        </c:if>
                                    </c:if>
                                </ul>
...
<script src="../../../../resources/js/manager/boardList.js"></script>
</body>
</html>
