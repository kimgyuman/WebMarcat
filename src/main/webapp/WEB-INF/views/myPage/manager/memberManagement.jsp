    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="/admin/memberManagement" class="nav-item nav-link active"><i
                ...
                <div class="col-sm-12 col-xl-12">
                    <div class="bg-white text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <h6 class="mb-0">회원 관리</h6>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <select id="mm-amountSelect" onchange="mmAmountChange()">
                            ...
                            <div class="search-layout d-flex justify-content-end">
                                ...
                                <input id="mm-input" type="text" placeholder="Search">
                                <i class="search-icon fa fa-search" onclick="mSearch()"></i>
                            </div>
                        </div>
                        <table class="am-table">
                            ...
                            <c:forEach var="memberdto" items="${memberDTO}">
                                <tr>
                                    <td style="width: 10%;">${memberdto.memberId}</td>
                                    <td style="width: 20%;">${memberdto.name}</td>
                                    <td style="width: 20%;">${memberdto.nickname}</td>
                                    <td style="width: 15%;">${memberdto.activated}</td>
                                    <td style="width: 15%;">${memberdto.createTime}</td>
                                    <td style="width: 15%;">
                                        <button style="width: 55%;" class="m-btn4">관리</button>
                                    </td>
                                </tr>
                            </c:forEach>
                        </table>
...
<script src="../../../../resources/js/manager/memberManagement.js"></script>
</body>
</html>