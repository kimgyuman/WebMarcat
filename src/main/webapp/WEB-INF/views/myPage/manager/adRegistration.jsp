            ...
            <div class="row g-4">
                <div class="col-sm-12 col-xl-12 bg-white">
                    <div id="all_file_container">
                        <h2>광고 등록</h2>
                        <form:form modelAttribute="addAdDTO" action="/admin/adRegistration" method="post" enctype="multipart/form-data"
                                   onsubmit="return adValidation();">
                        <hr>
                        <div class="d-flex justify-content-center">
                            <img id="preview-image" src="../../../../resources/img/error.png">
                        </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xl-7">
                                ...
                                <div class="form-floating mb-4">
                                    <form:input class="form-control" name="title" id="title" type="text" path="title"></form:input>
                                    <form:errors path="title"></form:errors>
                                    <label for="title">제목</label>
                                </div>

                                <div class="form-floating mb-5">
                                    <form:input class="form-control" name="url" id="url" type="text" path="url"></form:input>
...
<script src="../../../../resources/js/manager/addAd.js"></script>
