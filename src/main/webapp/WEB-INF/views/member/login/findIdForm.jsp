        ...
        <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
            <div class="d-table-cell align-middle">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="m-sm-5">
                            <form:form modelAttribute="signUpDTO">
                                ...
                                <div class="form-group">
                                    ...
                                    <span id="findId_msg" class="error_msg mt-4"></span>
                                </div>
                                <div class="text-center mt-5">
                                        <button type="button" class="btn btn-lg btn-primary btn-danger ml-sm-4" onclick="location.href='/'"
                                                id="cancel_btn">취소
                                        </button>
                                </div>
                            </form:form>
